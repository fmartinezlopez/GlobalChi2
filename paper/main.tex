...
\end{equation}
For any null vector $\mathbf{x}$ which satisfies the null-space condition of Eq. \ref{eq:null_condition}, the projection onto the shift vector results:
\begin{equation}
    \begin{split}
...
A qualitatively different situation arises when the systematic variation modifies the detector response matrix rather than the event weights.
