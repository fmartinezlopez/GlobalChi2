...
\end{equation}
where $\hat{\bm{\varphi}} = U \mathbf{d}$ is the unfolded background-subtracted data, $A_{C} = U \, R$ is the additional smearing matrix \cite{Tang:2017rob}, and $\bm{\varphi}_{\text{pred}}$ is a truth-level model prediction. The range-projected $\chi{^2}$ in unfolded space is:
